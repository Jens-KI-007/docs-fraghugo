...
- **Re-Audit fällig** — Audit aus dem Vorjahr, Erinnerung 30 Tage vorher.
- **Schulung abgelaufen** — Mitarbeiter sollte erneut absolvieren.
- **Stripe-Zahlung fehlgeschlagen** — Karte abgelaufen o.ä.
- **Externer DSB hat freigegeben** — Dokument zur Prüfung kam zurück.
...
In den Einstellungen einstellbar, z.B. keine Push-Benachrichtigungen zwischen 20:00 und 07:00 — kritische Events (Datenpanne) kommen trotzdem durch.
