---
title: "Verarbeitungsverzeichnis – So legen Sie los"
description: "Das Verarbeitungsverzeichnis (VVT) ist Pflicht nach Art. 30 DSGVO. Mit Hugo DSB legen Sie es in 30 Minuten an – mit Vorlagen statt leerem Formular."
---

<div class="article-meta">
  <span><span class="label">Für:</span> Geschäftsführer, Datenschutzkoordinator</span>
...
1. **Name des Verantwortlichen** (Sie)
2. **Zweck der Verarbeitung** (z. B. „Lohnabrechnung")
3. **Kategorien betroffener Personen** (z. B. „Mitarbeiter")
4. **Kategorien personenbezogener Daten** (z. B. „Stammdaten, Kontoverbindung, Steuer-ID")
5. **Empfänger der Daten** (z. B. „DATEV, Sozialversicherungsträger")
...
Loggen Sie sich in Hugo DSB ein. In der linken Navigation klicken Sie auf **„Verarbeitungsverzeichnis"**. Sie sehen eine leere Liste mit dem Hinweis „Noch keine Verarbeitungen angelegt".

Klicken Sie oben rechts auf **„Neue Verarbeitung anlegen"**.

## Schritt 2: Vorlage wählen (oder leer starten)

Hugo DSB schlägt Ihnen zuerst **Branchen-Vorlagen** vor. 90 % der KMU haben dieselben 10–15 Verarbeitungen:
...
Das Formular führt Sie durch die acht Pflichtfelder. Hugo DSB hilft mit:
...
Klicken Sie auf **„Speichern"**. Die Verarbeitung erscheint in der Übersichts-Liste. Hugo DSB rechnet Ihren Compliance-Score automatisch hoch.
...
Wenn Sie alle Verarbeitungen erfasst haben, klicken Sie auf **„VVT exportieren"**. Hugo DSB generiert ein PDF mit:
...
**„Muss ich JEDE Verarbeitung dokumentieren?"**
Ja, aber Hugo DSB macht es einfach. Statt 50 leere Excel-Felder ausfüllen zu müssen, beantworten Sie 8 Fragen pro Verarbeitung – mit vorbefüllten Vorschlägen.

**„Mein Geschäft ist speziell – passen die Vorlagen?"**
Die Vorlagen sind ein Startpunkt. Sie können jedes Feld ändern. Branchen-Spezifika (z. B. „Telematikdaten" für Spediteure) können Sie als Custom Field ergänzen.

**„Was, wenn ich später eine Verarbeitung ändere?"**
Hugo DSB führt automatisch ein Versionierungs-Log. Sie sehen, wann was geändert wurde, von wem, und können bei Bedarf zur alten Version zurück.

**„Kann mein DSB das auch sehen?"**
Ja. Wenn Sie einen externen DSB haben, laden Sie ihn als „Datenschutzbeauftragter" ein. Er bekommt Lesezugriff auf alles, kann kommentieren, aber nichts versehentlich löschen.
