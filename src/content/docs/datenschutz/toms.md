...
Pflicht nach Art. 32 DSGVO: Du musst dokumentieren, **wie** du personenbezogene Daten technisch und organisatorisch schützt. Hier listest du das auf.

## Kategorien (Standardgliederung)

Hugo gibt 8 Kategorien vor, in denen du jeweils ankreuzt was du machst:
...
5. **Pseudonymisierung & Verschlüsselung** — wo verschlüsselst du? (in Ruhe, im Transit)
...
8. **Auftragskontrolle** — wie kontrollierst du AVV? (Prüfung der Anbieter, Audit-Rechte)

## Was du hier machst

- **Maßnahmen ankreuzen** — pro Kategorie 5-15 Standard-Maßnahmen, du wählst.
- **Custom Maßnahmen** hinzufügen — falls du etwas Besonderes hast.
...
- **Letzte Prüfung** — wann hast du das zuletzt überprüft? (Pflicht: mind. 1× jährlich)
...
Jeder AVV bekommt eine Kopie deiner TOMs als Anlage 2 zum Vertrag. Hugo macht das automatisch bei AVV-Export.

## Tipps

- Bei kleinen Firmen reicht ein **Basis-Set von ~30 Maßnahmen**. Übertreibe nicht.
- Versprich nichts, was du nicht tust. Wenn "Vier-Augen-Prinzip" angekreuzt ist aber niemand das prüft, ist das schlechter als ehrliches "Nein, brauchen wir nicht weil Mini-Team".
