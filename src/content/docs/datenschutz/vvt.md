...
Klick "Neu" oben rechts. Zwei Wege:
...
- **Leer** — wenn du eine spezifische Eigen-Verarbeitung hast.
...
Klick auf einen Eintrag. Du kannst Felder ändern, **mit KI verbessern** (Hugo prüft Plausibilität und schlägt fehlende Felder vor), historisierte Versionen einsehen.

### Status

- **Entwurf** — du bearbeitest.
...
- **PDF** — formales Verzeichnis mit Header/Logo deiner Firma, für die Aufsichtsbehörde.
...
- **DSFA-Indikator**: Eine Verarbeitung mit roter Markierung ist DSFA-pflichtig (z.B. systematische Überwachung, Profiling, besondere Datenkategorien). Hugo sagt's dir.
- **AVV-Verknüpfung**: Wenn du einen Auftragsverarbeiter im VVT angibst, wird automatisch ein AVV-Eintrag verlangt — die beiden Bereiche sind verknüpft.
