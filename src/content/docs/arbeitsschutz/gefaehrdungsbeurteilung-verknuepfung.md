---
title: Verknüpfung mit der Gefährdungsbeurteilung
description: "Unterweisungen in Hugo Safe an die Gefährdungsbeurteilung anbinden — mit klarer Abgrenzung: Hugo Safe ergänzt die Gefährdungsbeurteilung nach § 5 ArbSchG, ersetzt sie aber nicht."
sidebar:
  order: 8
---
...
:::caution[Die wichtigste Abgrenzung zuerst]
**Hugo Safe ergänzt die Gefährdungsbeurteilung — es ersetzt sie nicht.** Die Gefährdungsbeurteilung (§ 5 ArbSchG) ist und bleibt eine eigenständige Arbeitgeberpflicht. Hugo Safe hilft Ihnen, die aus der Gefährdungsbeurteilung **abgeleiteten Unterweisungen** umzusetzen und nachzuweisen — die Beurteilung selbst erstellen Sie (ggf. mit Ihrer Sicherheitsfachkraft) separat.
:::
...
## Wenn Sie auch das ISMS / NIS2 nutzen

Die frag.hugo-Plattform vereint mehrere Compliance-Bereiche in einem Login. Wenn Sie zusätzlich [ISMS / NIS2](/isms-nis2/uebersicht/) nutzen, arbeiten Sie dort mit einer **anderen** Risiko-Logik (Informationssicherheit). Verwechseln Sie die beiden nicht: Die arbeitsschutzrechtliche Gefährdungsbeurteilung (§ 5 ArbSchG) und das Risiko-Register des ISMS sind zwei getrennte Welten.

:::note[Was Hugo Safe leistet]
Hugo Safe sorgt dafür, dass aus Ihrer Gefährdungsbeurteilung **lückenlose, nachweisbare Unterweisungen** werden. Die Beurteilung erstellen und aktualisieren Sie eigenständig — Hugo Safe ist die **Umsetzungs- und Nachweis-Schicht**, keine Gefährdungsbeurteilungs-Software und keine Rechtsberatung.
:::
