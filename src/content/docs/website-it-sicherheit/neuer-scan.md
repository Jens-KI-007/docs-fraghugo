...
So scannst du eine Website:

1. **URL eingeben** — `https://www.deine-firma.de` (mit oder ohne `https://`).
...
4. **Warten** — 30–60 Sekunden. Du siehst Live, was geprüft wird.
...
- Hat jeder Tracker einen Eintrag in deiner DSE?
...
## Im Ergebnis siehst du

- **Score** als große Zahl (0–100). 80+ ist gut, 90+ ist sehr gut.
- **Ampel pro Check** (rot/gelb/grün) mit Klick auf Details.
...
- **Re-Scan-Button** — nach Fixes nochmal durchlaufen lassen, dann hast du auch den Vorher/Nachher-Vergleich.

## Mit DSE verknüpfen

Wenn du auf der Plattform deine [Datenschutzerklärung](/datenschutz/dse/) gepflegt hast, vergleicht der Scan: "Du hast Matomo auf der Website, aber in deiner DSE steht nichts dazu." → konkreter Befund.
