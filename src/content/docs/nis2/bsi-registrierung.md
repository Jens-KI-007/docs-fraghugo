---
title: "BSI-Registrierung – Schritt für Schritt"
description: "NIS2-betroffene Unternehmen müssen sich beim BSI registrieren. So füllen Sie das BSI-Portal in 6 Schritten aus – mit vorausgefüllten Feldern aus Hugo DSB."
---

<div class="article-meta">
  <span><span class="label">Für:</span> Geschäftsführer, Compliance-Beauftragte</span>
  <span><span class="label">Lesezeit:</span> 7 Minuten</span>
</div>
...
Falls Sie unsicher sind, ob Sie betroffen sind: [NIS2-Betroffenheitscheck](/hugo-check/nis2-betroffenheit/).
...
## Schritt 1: Hugo DSB BSI-Guide öffnen
...
## Schritt 2: Auf das BSI-Portal gehen
...
## Schritt 5: Ansprechpartner und Kontakt benennen
...
## Schritt 6: Übermittlung und Bestätigung
...
## „Frist abgelaufen – ist es zu spät?"
...
- Sie können **Vorfälle melden** – mit der 24h-Frist (siehe [Vorfall melden](/nis2/vorfall-melden/))
...
**„Muss jeder Standort einzeln registriert werden?"**
Nein, Sie registrieren die **Rechtseinheit**. Wenn Ihre GmbH 5 Standorte hat, ist das eine Registrierung.

**„Was ist mit Tochterfirmen?"**
Jede rechtlich selbstständige Tochter braucht eine eigene Registrierung – auch innerhalb eines Konzerns.

**„Ich bin Zulieferer eines NIS2-Unternehmens, aber selbst nicht betroffen. Muss ich mich registrieren?"**
Nein. Aber Ihr Auftraggeber wird wahrscheinlich Sicherheits-Anforderungen an Sie weitergeben. Dafür gibt es [Hugo Shield](/hugo-shield/assessment-ausfuellen/).

**„Was kostet die Registrierung?"**
Sie ist kostenlos. Das BSI verlangt keine Gebühr.
