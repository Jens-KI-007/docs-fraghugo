...
- **Name** — z.B. "ChatGPT für Mitarbeiter", "Bewerber-Sortierung HR-Tool", "Predictive Maintenance Maschine X"
- **Anbieter** — OpenAI, Microsoft, eigene Entwicklung
- **Zweck** — wofür wird's verwendet
- **Daten-Inputs** — was geht rein (Texte, Bilder, Stammdaten)
- **Daten-Outputs** — was kommt raus (Empfehlung, Klassifikation, generierter Text)
- **Betroffene Personen** — wer ist von Entscheidungen betroffen (Bewerber, Kunden, Mitarbeiter)
- **Verantwortlicher** — wer in der Firma
- **Risiko-Klasse** (nach [Klassifizierung](/ki-compliance/klassifizierung/))
- **Status**: Pilot / Produktiv / Eingestellt
